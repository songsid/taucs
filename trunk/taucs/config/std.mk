DIRSRC=src$(PATHSEP)
DIRMATLABSRC = matlab$(PATHSEP)src$(PATHSEP)
...
DIRMEX=mex$(PATHSEP)$(OSTYPE)$(OSTYPE_VARIANT)$(PATHSEP)
...
clean:
	...
	- $(RM) mex$(PATHSEP)$(OSTYPE)$(OSTYPE_VARIANT)$(PATHSEP)*
	- $(RM) lib$(PATHSEP)$(OSTYPE)$(OSTYPE_VARIANT)$(PATHSEP)*.*
	- $(RM) obj$(PATHSEP)$(OSTYPE)$(OSTYPE_VARIANT)$(PATHSEP)*.*
	- $(RM) bin$(PATHSEP)$(OSTYPE)$(OSTYPE_VARIANT)$(PATHSEP)*.*
	- $(RM) mex$(PATHSEP)$(OSTYPE)$(OSTYPE_VARIANT)$(PATHSEP)*.*
